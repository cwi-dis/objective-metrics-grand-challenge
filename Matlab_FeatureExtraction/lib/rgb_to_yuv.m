...
% 
% 
% Conversion from RGB to YUV, using ITU-R BT.709. 
%       Simplified version of: "Nikola Sprljan (2020). YUV files reading 
%       and converting 
...
%
%   INPUTS
%       rgb: RGB color channels, with size Mx3
%
%   OUTPUTS
%       yuv: YUV channels, with size Mx3
...
yuv = [uint8(round(y)), uint8(round(u)), uint8(round(v))];
